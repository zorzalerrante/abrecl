...
define("matta_map", ["d3", "matta", "topojson", "leaflet"], function (d3, matta, topojson, leaflet) {
    var mod_map = function() {
        var func_map = function (selection) {
            console.log('selection', selection);
            selection.each(function(json) {
                var container = null;

                if (d3.select(this).select("div.map-container").empty()) {
                    ...
                    container = d3.select(this).select("div.map-container");
                }
...
var draw_topojson = function() {
    ...
    p.attr({
        ...
        console.log('symbols', symbols);
            ...
            var symbol_scale = d3.scale.linear()
                .range([0, 12])
            ...
            symbol.attr({
                ...
                'r': function(d) { return symbol_scale(d[_property_value]); },
    ...
    reset();
        ...
        var height = 350;
            ...
            var _symbol_color = "indigo";
            func_map.symbol_color = function(_) {
                if (arguments.length) {
                    _symbol_color = _;
                    console.log('setted symbol_color', _symbol_color);
                    return func_map;
                }
            ...
            func_map.property_value = function(_) {
                if (arguments.length) {
                    _property_value = _;
